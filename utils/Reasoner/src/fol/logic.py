...
class FuncSymbol():
    ...
    def __init__(self, name, arity, in_dtypes, out_dtype):
        self.name = name
        self.arity = arity
...
class PlannerPredicate(Predicate):
    """Neural predicats.
    ...
    def __init__(self, name, arity, dtypes):
        super(PlannerPredicate, self).__init__(name, arity, dtypes)
        self.name = name
        self.arity = arity
        self.dtypes = dtypes
    ...
    def __eq__(self, other):
        return type(other) == PlannerPredicate and self.name == other.name
